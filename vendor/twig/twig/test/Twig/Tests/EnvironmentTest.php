...
class Twig_Tests_EnvironmentTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @expectedException Twig_Error_Runtime
     * @expectedExceptionMessage Circular reference detected for Twig template "index.html.twig", path: index.html.twig -> index.html.twig in "index.html.twig" at line 1
     */
    public function testFailLoadTemplateOnCircularReference()
    {
        $twig = new Twig_Environment(new Twig_Loader_Array(array(
            'index.html.twig' => '{% extends "index.html.twig" %}',
        )));

        $twig->loadTemplate('index.html.twig');
    }
